...
#Bootstrap dotnet 7.0 for C# dev kit. Uses script downloaded by Start-PSBootstrap
& bash ./tools/dotnet-install.sh -Channel $env:CSHARP_DEV_KIT_RUNTIME_CHANNEL -Runtime dotnet
